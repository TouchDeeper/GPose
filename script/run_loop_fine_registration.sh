...
rm ../result/banana/fine_registration/*/*.txt
#rm ../result/joystick/fine_registration/*/*.txt
...
do
    ...
    do
        ...
        sed -i "s:^pure_GA_path.*\.txt$:pure_GA_path=fine_registration/$scene/pure_GA.txt:g" ${config_path}
        sed -i "s:^pure_icp_path.*\.txt$:pure_icp_path=fine_registration/$scene/pure_icp.txt:g" ${config_path}
        sed -i "s:^GA_icp_path.*\.txt$:GA_icp_path=fine_registration/$scene/GA_icp.txt:g" ${config_path}
