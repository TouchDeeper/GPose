...
sed -i "s:^pure_GA_path.*\.txt$:pure_GA_path=whole_pipe/scene1/pure_GA.txt:g" ${config_path}
sed -i "s:^pure_icp_path.*\.txt$:pure_icp_path=whole_pipe/scene1/pure_icp.txt:g" ${config_path}
sed -i "s:^GA_icp_path.*\.txt$:GA_icp_path=whole_pipe/scene1/GA_icp.txt:g" ${config_path}
sed -i "s:^time_path.*\.txt$:time_path=whole_pipe/scene1/time.txt:g" ${config_path}
